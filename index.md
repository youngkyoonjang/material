...
본 페이지는 페북에서 나누는 논의들을 기초로 딥러닝에 대한 이론부터 TensorFlow 및 Caffe 등과 같은 오픈소스를 통한 실습, 더 나아가 컴퓨터 비전 및 음성 인식 등 머신러닝과 로보틱스로의 활용까지, 가능한 넓은 범위의 내용을 스스로 공부할 수 있는 정돈된 문서로 남기고자 합니다. 
